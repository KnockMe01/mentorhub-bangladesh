        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="md:w-1/2 mb-12 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="rounded-full border-topmate-200 bg-white/80 hover:bg-white">
                Become a Mentor
              </Button>
            </div>
          </div>
          ...
          <div className="md:w-1/2 relative">
            <div className="relative w-full aspect-square max-w-md mx-auto">
              <div className="absolute inset-0 bg-gradient-to-tr from-topmate-200/30 to-topmate-100/30 rounded-[30px] rotate-6 transform-gpu"></div>
              <div className="absolute inset-0 bg-white rounded-[30px] overflow-hidden shadow-2xl border border-gray-100">
                <img 
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-4 shadow-lg border border-gray-100 w-32 h-32 flex items-center justify-center">
