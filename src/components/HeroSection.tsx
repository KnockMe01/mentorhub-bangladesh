  ...
  return (
    <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-topmate-100 rounded-full -translate-y-1/2 translate-x-1/3 opacity-60 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-topmate-200 rounded-full translate-y-1/3 -translate-x-1/3 opacity-50 blur-3xl"></div>
      </div>
          ...
          <div className="md:w-1/2 animate-slide-up [animation-delay:0.1s]">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="relative whitespace-nowrap">
                <span className="relative z-10"> Land Your Dream Job</span>
                <svg aria-hidden="true" viewBox="0 0 418 42" className="absolute -bottom-2 left-0 h-[0.58em] w-full fill-topmate-200/70" preserveAspectRatio="none">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-topmate-600 hover:bg-topmate-700 text-white font-medium px-6 py-3 rounded-full 
            ...
            <div className="relative w-full max-w-md aspect-square">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full h-full">
                  <div className="absolute top-4 left-4 right-4 bottom-4 bg-gradient-to-br from-topmate-100 to-topmate-50 rounded-2xl animate-float"></div>
