...
const Banner = () => {
  return (
    <div className="bg-gradient-to-r from-topmate-600 to-topmate-500 text-white text-sm py-2 px-4 text-center">
      <p className="flex items-center justify-center flex-wrap gap-1">
        ...
        <a 
          ...
          className="inline-flex items-center font-medium underline underline-offset-4 ml-1 hover:text-white/80"
        >
          LinkedIn
